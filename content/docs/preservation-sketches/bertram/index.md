...
|-----------------------------------------|----------------------------------------------------------------------|
| `$(document).ready(function() { <CODE> })` | Run `<CODE>` once the document has finished loading in the browser.   |
| `$('body').append( <CONTENT> );`        | Place `<CONTENT>` onto the page. This expression is repeated 44 times with different content. |
